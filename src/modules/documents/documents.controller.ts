...
@ApiAuth()
    ...
    schema: {
        ...
        file: {
            ...
            format: 'binary',
            description:
            'PDF, JPEG, or PNG file. Maximum size: 10 MB.',
        },
        },
    },
    })
    ...
    schema: {
        ...
        data: {
            ...
            bucket: 'ems',
            storagePath:
            'employees/employee-uuid/documents/file-uuid.pdf',
            status: 'PENDING',
    ...
    return this.documentsService.uploadMyDocument(
        user.id,
        dto,
        file,
    );
...
@ApiAuth()
    ...
    @ApiNotFoundResponse({
    description:
        'Document was not found for the authenticated employee.',
    })
    findMyDocumentById(
    @CurrentUser() user: RequestUser,
    @Param('documentId') documentId: string,
    ) {
    return this.documentsService.findMyDocumentById(
        user.id,
        documentId,
    );
    }
...
@ApiAuth()
    ...
    return this.documentsService.getMyDocumentFile(
        user.id,
        documentId,
    );
    }
...
@ApiAuth()
    ...
    return this.documentsService.deleteMyDocument(
        user.id,
        documentId,
    );
    }
